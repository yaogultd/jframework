...
public class BarcodeComponent extends JComponent implements PropertyChangeListener{
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#getBarHeigth()
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#getEncoder()
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#getNarrowWidth()
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#getPainter()
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#getWideToNarrow()
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#setBarHeigth(int)
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#setEncoder(j.tool.BarCode.encode.BarcodeEncoder)
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#setNarrowWidth(int)
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#setPainter(j.tool.BarCode.paint.BarcodePainter)
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#setWideToNarrow(int)
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#getTextPainter()
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#isCheckDigit()
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#isShowCheckDigit()
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#isShowText()
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#setCheckDigit(boolean)
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#setShowCheckDigit(boolean)
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#setShowText(boolean)
     */
    ...
    /* (non-Javadoc)
     * @see j.tool.BarCode.JBarcode#setTextPainter(j.tool.BarCode.paint.TextPainter)
     */
