...
public class UserAgents {
	...
	public static final String UA_WECHAT_MINI="UA_WECHAT_MINI";
	public static final String[] UA_WECHAT_MINI_KEYWORDS=new String[]{"miniprogram"};

	public static final String UA_ALIPAY="UA_ALIPAY";
	public static final String[] UA_ALIPAY_KEYWORDS=new String[]{"alipayclient"};

	public static final String UA_ALIPAY_MINI="UA_ALIPAY_MINI";
	public static final String[] UA_ALIPAY_MINI_KEYWORDS=new String[]{"miniprogram"};

	public static final String UA_DOUYIN_MINI="UA_DOUYIN_MINI";
	public static final String[] UA_DOUYIN_MINI_KEYWORDS=new String[]{"toutiaomicroapp"};
	...
	public final static String screenw="screenw";//屏幕宽度
	public final static String screenh="screenh";//屏幕高度
	...
	public static String getUserAgentType(HttpServletRequest request) {
		...
		if(JUtilString.existsIgnoreCase(ua,UA_WECHAT_KEYWORDS)){
			return JUtilString.existsIgnoreCase(ua,UA_WECHAT_MINI_KEYWORDS) ? UA_WECHAT_MINI : UA_WECHAT;
		}else if(JUtilString.existsIgnoreCase(ua,UA_ALIPAY_KEYWORDS)){
			return JUtilString.existsIgnoreCase(ua,UA_ALIPAY_MINI_KEYWORDS) ? UA_ALIPAY_MINI : UA_ALIPAY;
		}else if(JUtilString.existsIgnoreCase(ua,UA_DOUYIN_MINI_KEYWORDS)){
			return UA_DOUYIN_MINI;
	 ...
	 * @return
	 */
	public static String getWechatMiniProgramId(HttpServletRequest request){
		if(request==null) return null;
		return getWechatMiniProgramId(request.getHeader("User-Agent"));
	}
	 ...
	 * @return
	 */
	public static String getWechatMiniProgramId(String ua){
		if(ua==null) return null;
		String[] infos = ua.split("\\s{1}");
