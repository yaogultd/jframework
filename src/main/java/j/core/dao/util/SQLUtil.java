...
public final class SQLUtil {
	...
	static{
		javaTypeMapping.put(Integer.valueOf(-7),"java.lang.Boolean");//BIT
		javaTypeMapping.put(Integer.valueOf(-6),"java.lang.Short");//TINYINT
		javaTypeMapping.put(Integer.valueOf(5),"java.lang.Short");//SMALLINT
		javaTypeMapping.put(Integer.valueOf(4),"java.lang.Integer");//INTEGER
		javaTypeMapping.put(Integer.valueOf(-5),"java.lang.Long");//BIGINT
		javaTypeMapping.put(Integer.valueOf(6),"java.lang.Float");//FLOAT
		javaTypeMapping.put(Integer.valueOf(7),"java.lang.Double");//REAL
		javaTypeMapping.put(Integer.valueOf(8),"java.lang.Double");//DOUBLE
		javaTypeMapping.put(Integer.valueOf(2),"java.math.BigDecimal");//NUMERIC
		javaTypeMapping.put(Integer.valueOf(3),"java.math.BigDecimal");//DECIMAL
		javaTypeMapping.put(Integer.valueOf(1),"java.lang.String");//CHAR
		javaTypeMapping.put(Integer.valueOf(12),"java.lang.String");//VARCHAR
		javaTypeMapping.put(Integer.valueOf(-1),"java.lang.String");//LONGVARCHAR
		javaTypeMapping.put(Integer.valueOf(91),"java.sql.Date");//DATE
		javaTypeMapping.put(Integer.valueOf(92),"java.sql.Time");//TIME
		javaTypeMapping.put(Integer.valueOf(93),"java.sql.Timestamp");//TIMESTAMP
		javaTypeMapping.put(Integer.valueOf(-2),"java.io.InputStream");//BINARY
		javaTypeMapping.put(Integer.valueOf(-3),"java.io.InputStream");//VARBINARY
		javaTypeMapping.put(Integer.valueOf(-4),"java.io.InputStream");//LONGVARBINARY
		javaTypeMapping.put(Integer.valueOf(2004),"java.sql.Blob");//BLOB
		javaTypeMapping.put(Integer.valueOf(2005),"java.sql.Clob");//CLOB
		javaTypeMapping.put(Integer.valueOf(16),"java.lang.Boolean");//BOOLEAN
		

		javaTypeMapping.put("java.lang.Boolean",Integer.valueOf(-7));//BIT
		javaTypeMapping.put("java.lang.Short",Integer.valueOf(-6));//TINYINT
		javaTypeMapping.put("java.lang.Short",Integer.valueOf(5));//SMALLINT
		javaTypeMapping.put("java.lang.Integer",Integer.valueOf(4));//INTEGER
		javaTypeMapping.put("java.lang.Long",Integer.valueOf(-5));//BIGINT
		javaTypeMapping.put("java.lang.Float",Integer.valueOf(6));//FLOAT
		javaTypeMapping.put("java.lang.Double",Integer.valueOf(7));//REAL
		javaTypeMapping.put("java.lang.Double",Integer.valueOf(8));//DOUBLE
		javaTypeMapping.put("java.math.BigDecimal",Integer.valueOf(2));//NUMERIC
		javaTypeMapping.put("java.math.BigDecimal",Integer.valueOf(3));//DECIMAL
		javaTypeMapping.put("java.lang.String",Integer.valueOf(1));//CHAR
		javaTypeMapping.put("java.lang.String",Integer.valueOf(12));//VARCHAR
		javaTypeMapping.put("java.lang.String",Integer.valueOf(-1));//LONGVARCHAR
		javaTypeMapping.put("java.sql.Date",Integer.valueOf(91));//DATE
		javaTypeMapping.put("java.sql.Time",Integer.valueOf(92));//TIME
		javaTypeMapping.put("java.sql.Timestamp",Integer.valueOf(93));//TIMESTAMP
		javaTypeMapping.put("java.io.InputStream",Integer.valueOf(-2));//BINARY
		javaTypeMapping.put("java.io.InputStream",Integer.valueOf(-3));//VARBINARY
		javaTypeMapping.put("java.io.InputStream",Integer.valueOf(-4));//LONGVARBINARY
		javaTypeMapping.put("java.sql.Blob",Integer.valueOf(2004));//BLOB
		javaTypeMapping.put("java.sql.Clob",Integer.valueOf(2005));//CLOB
		javaTypeMapping.put("java.lang.Boolean",Integer.valueOf(16));//BOOLEAN		
	}
	...
	public static String getJavaTypeName(int columnType){
		return (String)javaTypeMapping.get(Integer.valueOf(columnType));
	}
	 ...
	 * @param vo 根据bean中指定字段（0个或多个）所组成的条件，将符合条件的记录更新成bean所表示的状态（不包括作为条件的自段）
	...
	public static String retrieveUpdateSQL(Object vo, String[] conditionKeys,DAOFactory factory) throws Exception {
		...
		Database db = factory==null?null:DB.database(factory.getDbName());
		...
		for(int i=0;i<cols.size();i++){
			...
			if(JUtilString.containIgnoreCase(conditionKeys,colName)
					||(db!=null && db.ignoreWhileUpdateViaBean(tblName, colName))){
				continue;
			}
	 ...
	 * @param vo 根据bean中指定字段（0个或多个）所组成的条件，将符合条件的记录更新成bean所表示的状态（不包括作为条件的自段和为null的字段）
	 * @param conditionKeys 组成的条件的字段名数组，不区分大小写
	 * @param factory
	 * @return
	 * @throws Exception
