...
public interface DAO{
	...
	public static final String DB_TYPE_ES="ES";
	 ...
	 * @param tblPattern 表名（可包含通配符?和*，null表示全部）
	 * @param tblTypes 取值范围：TABLE, VIEW, SYSTEM TABLE, GLOBAL TEMPORARY, LOCAL TEMPORARY, ALIAS, SYNONYM
	 *
	 * @return 相关对象名称的列表
	 * @throws Exception
	 */
	...
	//////////////////////////////////////////////////////////////////////////////
	/////////////////////////////////设置运行时业务参数（比如可用于了解是业务系统里那个用户触发的查询）/////////////////////////
