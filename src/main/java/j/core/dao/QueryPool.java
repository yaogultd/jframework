...
public class QueryPool implements Runnable{
	...
	private static ConcurrentMap<String, QueryPool> pools=new ConcurrentMap();
	private String databasename=null;
	private String poolName;
	private int executors=1;
	private ConcurrentList<QueryExecutor> threads=new ConcurrentList();
	private volatile long commands=0;
	private static final Object lock=new Object();
	
	public static final String COMMON_POOL="COMMON_POOL";
	public static int COMMON_POOL_SIZE=10;
	
	static{
		String temp= JProperties.getProperty("QueryPool.Common.Size");
	...
	public Double sumNumeric(String uuid,String table,String column,String condition){
		...
		return JUtilMath.isNumber(sum)?Double.parseDouble(sum):Double.valueOf(0);
	}
	 ...
	 * @param sql
	 */
	public QueryExecutor queryAsyn(String uuid, String sql){
		commands++;
	 ...
	 * @param pn
	 */
	public QueryExecutor queryAsyn(String uuid,String sql,int rpp,int pn){
		commands++;
		QueryExecutor exe=selectExecutor();
		if(uuid==null) uuid=JUtilUUID.genUUID();
	 ...
	 * @param condition
	 */
	public QueryExecutor queryAsyn(String uuid,String table,String condition){
		commands++;
		QueryExecutor exe=selectExecutor();
		if(uuid==null) uuid=JUtilUUID.genUUID();
	 ...
	 * @param pn
	 */
	public QueryExecutor queryAsyn(String uuid,String table,String condition,int rpp,int pn){
		commands++;
		QueryExecutor exe=selectExecutor();
		if(uuid==null) uuid=JUtilUUID.genUUID();
	 ...
	 * @param condition
	 */
	public QueryExecutor queryAsyn(String uuid,String[] tables,String condition){
		commands++;
		QueryExecutor exe=selectExecutor();
		if(uuid==null) uuid=JUtilUUID.genUUID();
	 ...
	 * @param pn
	 */
	public QueryExecutor queryAsyn(String uuid,String[] tables,String condition,int rpp,int pn){
		commands++;
		QueryExecutor exe=selectExecutor();
		if(uuid==null) uuid=JUtilUUID.genUUID();
	 ...
	 * @return
	 */
	public QueryExecutor querySingleAsyn(String uuid,String table,String condition){
		commands++;
		QueryExecutor exe=selectExecutor();
		if(uuid==null) uuid=JUtilUUID.genUUID();
	 ...
	 * @return
	 */
	public QueryExecutor querySingleAsyn(String uuid,String[] tables,String condition){
		commands++;
		QueryExecutor exe=selectExecutor();
		if(uuid==null) uuid=JUtilUUID.genUUID();
	 ...
	 * @return
	 */
	public QueryExecutor countAsyn(String uuid,String sql){
		commands++;
		QueryExecutor exe=selectExecutor();
		if(uuid==null) uuid=JUtilUUID.genUUID();
	 ...
	 * @return
	 */
	public QueryExecutor countAsyn(String uuid,String table,String condition){
		QueryExecutor exe=selectExecutor();
		if(uuid==null) uuid=JUtilUUID.genUUID();
	 ...
	 * @return
	 */
	public QueryExecutor countAsyn(String uuid,String[] tables,String condition){
		commands++;
		QueryExecutor exe=selectExecutor();
		if(uuid==null) uuid=JUtilUUID.genUUID();
	 ...
	 * @return
	 */
	public Object result(QueryExecutor executor, String uuid){
		return executor==null?null:executor.result(uuid);
	}
	...
	public void run() {
		while(!Startup.isDestroyed()){
			...
			try{
				...
				for(int i=0;i<threads.size();i++){
					QueryExecutor exe=threads.get(i);
