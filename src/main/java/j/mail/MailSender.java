...
public class MailSender implements Runnable{	
	 ...
	 * @param config
	 */
	public MailSender(String id,int num,MailSenderConfig config){
		this.id=id;
		this.num=num;
		this.config=config;
	}
	 ...
	 * @param config
	 */
	public void setConfig(String id,int num,MailSenderConfig config){
		this.id=id;
		this.num=num;
		this.config=config;
	}
	...
	public boolean doSend(String to,String cc,String subj,String text,String type,String encoding,String fromName){
		try {
			...
			if(config.getSecure()){
				...
				props.setProperty("mail.smtp.ssl.protocols", config.getProtocols());
				if(!config.getTls()){
