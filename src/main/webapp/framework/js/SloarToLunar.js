...
//时间格式：2024-01-16 21:32:00
function sloarToLunar0(t){
	let sy = t.substring(0, 4)*1;
	let sm = t.substring(5, 7)*1;
	let sd = t.substring(8, 10)*1;
	return sloarToLunar(sy, sm, sd);
}  

//时间格式：1707571800000
function sloarToLunar1(t){
	let time=new Date(t*1);
	return sloarToLunar(time.getFullYear(), time.getMonth()+1, time.getDate());
} 
